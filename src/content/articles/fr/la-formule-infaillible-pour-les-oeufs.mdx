...
Pour aller plus loin sur les jaunes d'œufs comme base de sauce, le [Miso Udon Carbonara](/fr/recettes/miso-udon-carbonara/) les place au cœur du plat d'une façon qui rend la technique visible. Et pour voir les œufs faire un travail structurel en pâtisserie plutôt que dans une poêle, la [Pâte à Choux](/fr/recettes/pate-a-choux/) utilise la même logique des protéines à haute chaleur pour construire quelque chose qui n'a rien à voir avec le déjeuner.
